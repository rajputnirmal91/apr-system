...
import { useGetEmployeeDetailsQuery } from '@project/Store/Api/Irm'

import IrmCertificationsTab from './IrmCertificationsTab/IrmCertificationsTab'
import IrmHelp from './IrmHelp/IrmHelp'
import type { PedpSavePayload } from './IrmPedpTab/IrmPedpTab'
import IrmPedpTab from './IrmPedpTab/IrmPedpTab'
import IrmProjectsTab from './IrmProjectsTab/IrmProjectsTab'

import './IrmDetailsTab.scss'

const tabs = [
  { key: 'tab1', label: 'Projects', icon: InfoIcon, Component: IrmProjectsTab },
  {
    key: 'tab2',
    label: 'Certifications',
    icon: RightArrow,
    Component: IrmCertificationsTab,
  },
  { key: 'tab3', label: 'PEDP', icon: RightArrow, Component: IrmPedpTab },
]
          ...
          <div className="d-flex chain-tabs px-0">
            ...
            <div className="last-tab">
              <div className="d-flex align-items-center justify-content-lg-end mt-4 mt-lg-0 gap-2">
                <div>
                  {' '}
                  {activeTab === 'tab3' && getFormStatus !== 'Reviewed' && (
